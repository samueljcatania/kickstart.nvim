...
-- Keymap to clear Avante chat history
vim.keymap.set('n', '<leader>aC', ':AvanteClear<CR>', { desc = 'avante: clear chat' })
...
end, { desc = 'Load the [s]ession for the current directory' })
...
end, { desc = "Stop persistence so the session won't be saved on exit" })
